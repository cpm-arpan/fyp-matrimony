							...
							while ($rw = mysqli_fetch_array($rn1)) {
								...
								<li><a href="comment.php?id=<?php echo $p_id; ?>">
										<div style="background: #eeeeee; padding: 10px;">
											<h6 style="margin:0;"><span class="commenter">
													<?php echo $sender_name; ?>
												</span> commented on your post <span class="post_cont"
													style=" font-weight: bold;">'
													<?php echo $content ?>...'
												</span></h6>
											<h6 style="margin:0; font-style: italic;">'
												<?php echo $comment; ?>...'
											</h6>
											<h6 style="margin:0;">
												<?php echo $time; ?> -
		...
		<div style="position: absolute;  bottom: 0; width: 100%; height: 10px;">
			...
			<div class="row"
				...
				<div class="col-md-6" style="padding: 10px 10px;">
					<h6 style=" color: white; text-align: center;"><b <small>Developed by <a href="#"
								class="myname"><u>Arpan, Razan, Prasiddha
									></a></small></b></h6>
				</div>
			</div>
		</div>
