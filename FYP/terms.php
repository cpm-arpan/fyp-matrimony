			...
			<div class="col-md-9">
				<div class="tab-content" id="v-pills-tabContent"
					...
					<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
						...
						<h5 style="color: #7f7f7f;">5) No sexual Yes Regiment can be made; If any victim, the
							authorities should be informed properly.</h5>
						...
						<h5 style="color: #7f7f7f;">8) No ID can be opened in the name of any business organization,
							organization, agency, company etc. </h5>
						<h5 style="color: #7f7f7f;">9) Advertising is not permitted for any type of business
							organization, organization, agency or any type. </h5>
						<h5 style="color: #7f7f7f;">10) The authority reserves the right to email, message or call on
							your personal email id or mobile number. </h5>
						<h5 style="color: #7f7f7f;">11) The authorities should be informed if there is any technical
							problem. </h5>
						<h5 style="color: #7f7f7f;">12) The authorities are not responsible for any fraud, financial
							transactions, crime and misinformation. </h5>
						<h5 style="color: #7f7f7f;">13) The Authority reserves the right to store, cancel and exchange
							all information in your account. </h5>
						<h5 style="color: #7f7f7f;">14) The authority reserves the right to change any decision at any
							time if necessary. </h5>
						<h5 style="color: #7f7f7f;">15) The authorities have the right to take action against any kind
							of unwanted / unlawful crime in accordance with local law. </h5>
						<h5 style="color: #7f7f7f;">16) You agree to the terms of the Authority and you are hereby
							completing the Registration. </h5>
